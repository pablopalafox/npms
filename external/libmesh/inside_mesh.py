...
class MeshIntersector:
    ...
    def query(self, points):
        ...
        # cull points outside of the axis aligned bounding box (aabb)
        ...
        # print("num points", points.shape[0]*2)
        # print("num triangles", self._triangles.shape)

        # Compute intersection depth and check order
        points_indices, tri_indices = self._tri_intersector2d.query(points[:, :2])

        # print("num points indices", len(points_indices))
        # print("num triangle indices", len(tri_indices))
        ...
        #     print(f'\tWarning: contains1 != contains2 for some points ({sum(contains1 != contains2)} points).')
        # else:
        #     print('\tBoth contains are the same for all points')
