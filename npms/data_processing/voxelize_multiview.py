...
if __name__ == "__main__":
    ...
    # dataset_name = "POSE_MIX__amass-151698ts__mixamo_trans_all-210585ts"
    
    # dataset_name = "MANO_EXTENDED-POSE-TRAIN-100id-10000ts-10000seqs"
    # dataset_name = "MANO-POSE-TEST-test-1id-50ts-50seqs"
