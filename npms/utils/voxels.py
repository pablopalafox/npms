...
from external.libvoxelize.voxelize import voxelize_mesh_
...
class VoxelGrid:
    ...
    @classmethod
    def from_mesh(
        cls, mesh, resolution, loc=None, scale=None, method='ray', return_transformed_mesh=False
    ):
        ...
        if return_transformed_mesh:
            return voxels, transformed_mesh
